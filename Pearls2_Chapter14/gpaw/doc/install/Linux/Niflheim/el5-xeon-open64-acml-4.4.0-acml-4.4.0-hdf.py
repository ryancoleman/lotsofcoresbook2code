...
library_dirs =[
    ...
    '/opt/scalapack/1.8.0/1.el5.fys.open64.4.2.3.openmpi.1.3.3.acml.4.4.0.acml.4.4.0/lib64',
...
extra_link_args =[
    ...
    '-rpath=/opt/scalapack/1.8.0/1.el5.fys.open64.4.2.3.openmpi.1.3.3.acml.4.4.0.acml.4.4.0/lib64,'
