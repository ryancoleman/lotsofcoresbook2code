...
library_dirs =[
    ...
    '/opt/scalapack/2.0.1/1.el5.fys.open64.4.2.3.openmpi.1.3.3.goto2.2.1.13.acml.4.4.0/lib64',
...
extra_link_args =[
    ...
    '-rpath=/opt/scalapack/2.0.1/1.el5.fys.open64.4.2.3.openmpi.1.3.3.goto2.2.1.13.acml.4.4.0/lib64,'
