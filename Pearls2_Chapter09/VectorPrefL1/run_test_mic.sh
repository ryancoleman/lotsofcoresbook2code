...
# Your mileage may vary
EXECUTABLE=`pwd`/build_mic/tests/time_dslash_noqdp
EXECUTABLE_ARGS="-x 32 -y 32 -z 32 -t 64 -by 4 -bz 4 -pxy 1 -pxyz 0 -c 59 -sy 1 -sz 4 -prec f -i 300 -minct 1 -compress12"
...
export I_MPI_MIC=1
mpiexec.hydra -n 1 -host ${TARGET_MIC} -genv LD_LIBRARY_PATH=${OMPLOCATION}:$LD_LIBRARY_PATH -env KMP_AFFINITY=compact,granularity=thread -env OMP_NUM_THREADS=237 ${EXECUTABLE} ${EXECUTABLE_ARGS}
