...
int fsBGKShanChenWetting();
int fsBGKEDMShanChenWetting();
int fsBGKGuoShanChenWetting();
int fsMRTShanChenWetting();
int fsMRTEDMShanChenWetting();
int fsMRTGuoShanChenWetting();
