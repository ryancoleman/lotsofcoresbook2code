...
int main( int argc, char *argv[] ){
    ...
    int gamma_size_pad = (terms+7) & ~7;
    int gamma_total = terms*gamma_size_pad;
    ...
    if(rank==0)
    {
        puts("Writing gamma output to ./Output/rmpi_V10.output...");
        FILE *foutput = fopen("./Output/rmpi_V10.output", "w");
