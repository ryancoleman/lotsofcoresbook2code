...
typedef struct
{
    ...
    double* xdiff;
    double* ixdiff;
    double* plijkz;     // array to store blocks of plijk*z in calculate_gamma_3d
...
extern _OFFLOADABLE void calculate_gamma_3d(thread_g3d_data_t* thread_data, int maxblocksize);
...
extern _OFFLOADABLE double calculate_xint(int l1, int l2, int l3, int n, int xsize, double* x,    double* y, double * restrict xdiff, double * restrict ixdiff);
