...
int main(int argc, char *argv[])
{
 ...
 #pragma offload target(mic) in(n_offset,t_offset,t_len1) \
                             in(t_len2:length(n_set)) \
                             in(t_seq1,t_res1:length(n_tar)) \
                             in(t_seq2,t_res2:length(n_off)) \
                             in(t_xyz1:length(n_tar*3)) \
                             in(t_xyz2:length(n_off*3)) \
                             out(t_sco1,t_sco2,t_sco3,t_sco4:length(n_set)) \
