...
#ifndef __FRTMALIGN_MIC_H_
#define __FRTMALIGN_MIC_H_

#include "size.h"

extern"C" {
 
 int __attribute__((target(mic))) frtmalign_( int *, double *, double *, double *, int *, int *, char (*)[MAXPRO], char (*)[MAXPRO], int (*)[MAXPRO], int (*)[MAXPRO], int (*)[MAXPRO], double (*)[MAXPRO][3], double (*)[MAXPRO][3], double (*)[3], double (*)[3][3], int * ); 
