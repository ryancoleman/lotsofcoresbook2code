...
void nw_gold(int *input_itemsets, int *output_itemsets, int *referrence,
...
#pragma omp parallel for schedule(static) shared(input_itemsets, referrence) firstprivate(blk, max_rows, max_cols, penalty)
        ...
        for( int b_index_x = 0; b_index_x < blk; ++b_index_x)
        {
            ...
            __declspec(align(64)) int input_itemsets_l[(BLOCK_SIZE + 1) *(BLOCK_SIZE+1)];
            __declspec(align(64)) int reference_l[BLOCK_SIZE * BLOCK_SIZE];
...
runTest( int argc, char** argv) 
{
    ...
    nw_optimized/*nw_gold*/( input_itemsets, output_itemsets, referrence,
