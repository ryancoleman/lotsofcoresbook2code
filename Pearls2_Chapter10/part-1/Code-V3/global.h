...
extern void calculate_gamma_3d(int n, int i, double *mvec, int xsize, double *xvec, double *yvec, DFTaskPtr task);
extern void gamma_3d_host(double * restrict gamma_flat, int gamma_size, int lmax);
extern double calculate_xint(int l1, int l2, int l3, int n, int xsize, double* x,    double* y, DFTaskPtr task);
extern double plijk(int r,int i,int j,int k);
extern double get_beta(int l, int n, int i);
extern double get_basis_late(int i, int p);
...
extern  int get_pmax_prim();
extern int create_order_prim();
extern  void find_perm_prim(int r,int* p1,int* p2,int* p3);
extern int set_terms_late();
extern int get_terms_late();
extern  int get_pmax_late();
...
extern  double get_basis_late(int i, int j);
extern  double* get_basis_late_array();

extern int create_beta(int l_size, int x_size);
extern  double* get_beta_array();
extern int read_beta();

extern  int get_b_lsize();
extern  int get_b_xsize();
extern int get_b_lvec(int *vec);
extern  int get_b_xvec(double *vec);
