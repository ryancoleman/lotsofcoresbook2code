...
(time mpiexec.hydra -n 1 -hosts mic0 ./stest_hybrid_fine.x < input_6GB_p1.txt ) >& t200_p1_6GB_phi.log 

export OMP_NUM_THREADS=100
export MIC_OMP_NUM_THREADS=100
(time mpiexec.hydra -n 2 -hosts mic0 ./stest_hybrid_fine.x < input_6GB_p1x1x2.txt ) >& t100_p1x1x2_6GB_phi.log 
...
(time mpiexec.hydra -n 20 ./stest_hybrid_fine.x < input_6GB_p2x2x5.txt ) >& t2_p2x2x5_6GB_host.log

# 40 MPI processes on all 40 logical cores (again using hyperthreads):
export OMP_NUM_THREADS=1
(time mpiexec.hydra -n 40 ./stest_hybrid_fine.x < input_6GB_p2x4x5.txt ) >& t1_p2x4x5_6GB_host.log 
