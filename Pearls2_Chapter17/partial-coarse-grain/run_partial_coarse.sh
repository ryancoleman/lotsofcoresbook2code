...
(time mpiexec.hydra -n 20 ./stest_hybrid_part_coarse.x < input_6GB_p2x2x5.txt ) >& t2_p2x2x5_6GB_host.log

# 40 MPI processes on all 40 logical cores (again using hyperthreads):
export OMP_NUM_THREADS=1
(time mpiexec.hydra -n 40 ./stest_hybrid_part_coarse.x < input_6GB_p2x4x5.txt ) >& t1_p2x4x5_6GB_host.log 
